...
for mass in masses:
    for lifetime in lifetimes:
        ...
        canvas.BuildLegend()
        canvas.SetGrid()
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_lowerRestriction_"+str(windowMinY).replace(".","p")+"_"+WP_tagName+".png")
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_lowerRestriction_"+str(windowMinY).replace(".","p")+"_"+WP_tagName+".pdf")
        ...
        canvas.BuildLegend()
        canvas.SetGrid()
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_yRestricted_lowerRestriction_"+str(windowMinY).replace(".","p")+"_"+WP_tagName+".png")
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_yRestricted_lowerRestriction_"+str(windowMinY).replace(".","p")+"_"+WP_tagName+".pdf")
        ...
        canvas.BuildLegend()
        canvas.SetGrid()
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_lowerRestriction_"+str(windowMinY).replace(".","p")+"_noAddVRUncertainty_"+WP_tagName+".png")
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_lowerRestriction_"+str(windowMinY).replace(".","p")+"_noAddVRUncertainty_"+WP_tagName+".pdf")
        ...
        canvas.BuildLegend()
        canvas.SetGrid()
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_yRestricted_lowerRestriction_"+str(windowMinY).replace(".","p")+"_noAddVRUncertainty_"+WP_tagName+".png")
        canvas.SaveAs(outputDir+"scan_xDirection_yDirection_yRestricted_lowerRestriction_"+str(windowMinY).replace(".","p")+"_noAddVRUncertainty_"+WP_tagName+".pdf")
