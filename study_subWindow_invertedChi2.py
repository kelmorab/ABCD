...
cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
...
gr_M15_ctau1_data_VR_xMax_1_yCut_0p85_xCut_0p5_0p9.SetName("VR data xMax=1 yCut=0.85 xCut=[0.5,0.9]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))

cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             windowMinX=0.0, windowMaxX=0.85, windowMinY=0.0, windowMaxY=1.0, otherDirectionCut=0.85,
...
gr_M15_ctau1_data_VR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.SetName("VR data xMax=0.85 yCut=0.85 xCut=[0.5,0.84]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))

cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             windowMinX=0.0, windowMaxX=0.7, windowMinY=0.0, windowMaxY=1.0, otherDirectionCut=0.7,
...
gr_M15_ctau1_data_VR_xMax_0p7_yCut_0p7_xCut_0p5_0p69.SetName("VR data xMax=0.7 yCut=0.7 xCut=[0.5,0.69]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_xMax_1_yCut_0p85_xCut_0p5_0p9.SetName("VR QCD xMax=1 yCut=0.85 xCut=[0.5,0.9]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.SetName("VR QCD xMax=0.85 yCut=0.85 xCut=[0.5,0.84]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_xMax_0p7_yCut_0p7_xCut_0p5_0p69.SetName("VR QCD xMax=0.7 yCut=0.7 xCut=[0.5,0.69]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_data_SR_xMax_0p7_yCut_0p7_xCut_0p5_0p69.SetName("SR data xMax=0.7 yCut=0.7 xCut=[0.5,0.69]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_xMax_0p7_yCut_0p7_xCut_0p5_0p69.SetName("SR QCD xMax=0.7 yCut=0.7 xCut=[0.5,0.69]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.SetName("SR QCD xMax=0.85 yCut=0.85 xCut=[0.5,0.84]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_xMax_1_yCut_0p85_xCut_0p5_0p9.SetName("SR QCD xMax=1 yCut=0.85 xCut=[0.5,0.9]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             ...
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
gr_M15_ctau1_data_SR_xMax_0p85_yCut_0p85_xCut_0p5_0p84 = ROOT.TGraph()
for i in range(len(cutValue_list)):
    gr_M15_ctau1_data_SR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.SetPoint(i,cutValue_list[i],nonClosure_list[i])
gr_M15_ctau1_data_SR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.SetLineColor(ROOT.kOrange)
gr_M15_ctau1_data_SR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.SetName("SR data xMax=0.85 yCut=0.85 xCut=[0.5,0.84]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             ...
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
gr_M15_ctau1_data_SR_xMax_1_yCut_0p85_xCut_0p5_0p9 = ROOT.TGraph()
for i in range(len(cutValue_list)):
    gr_M15_ctau1_data_SR_xMax_1_yCut_0p85_xCut_0p5_0p9.SetPoint(i,cutValue_list[i],nonClosure_list[i])
gr_M15_ctau1_data_SR_xMax_1_yCut_0p85_xCut_0p5_0p9.SetLineColor(ROOT.kMagenta)
gr_M15_ctau1_data_SR_xMax_1_yCut_0p85_xCut_0p5_0p9.SetName("SR data xMax=1 yCut=0.85 xCut=[0.5,0.9]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
###################################################################################################

canvas_M15_ctau1_xWindow=ROOT.TCanvas("canvas_M15_ctau1_xWindow","canvas_M15_ctau1_xWindow",1024,800)
...
gr_M15_ctau1_data_VR_xMax_1_yCut_0p85_xCut_0p5_0p9.GetXaxis().SetTitle("x-axis cut")
gr_M15_ctau1_data_VR_xMax_1_yCut_0p85_xCut_0p5_0p9.GetYaxis().SetTitle("predicted/observed")
...
gr_M15_ctau1_data_SR_xMax_1_yCut_0p85_xCut_0p5_0p9.Draw("sameL")
gr_M15_ctau1_data_SR_xMax_0p85_yCut_0p85_xCut_0p5_0p84.Draw("sameL")
canvas_M15_ctau1_xWindow.BuildLegend()
canvas_M15_ctau1_xWindow.SetGrid()
canvas_M15_ctau1_xWindow.SaveAs("c_M15_ctau1_xWindow_comparison_invertedChi2.png")
canvas_M15_ctau1_xWindow.SaveAs("c_M15_ctau1_xWindow_comparison_invertedChi2.pdf")
...
gr_M15_ctau1_data_VR_yMax_1_yCut_0p85_xCut_0p5_0p95.SetName("VR data yMax=1 yCut=0.85 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_data_VR_yMax_1_yCut_0p7_xCut_0p5_0p95.SetName("VR data yMax=1 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))

cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             windowMinX=0.0, windowMaxX=1, windowMinY=0.0, windowMaxY=0.85, otherDirectionCut=0.7,
                             scanMin=0.5, scanMax=0.95,
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
...
gr_M15_ctau1_data_VR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.SetName("VR data yMax=0.85 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))

cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             windowMinX=0.0, windowMaxX=1, windowMinY=0.0, windowMaxY=0.7, otherDirectionCut=0.6,
                             scanMin=0.5, scanMax=0.95,
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
...
gr_M15_ctau1_data_VR_yMax_0p7_yCut_0p6_xCut_0p5_0p95.SetName("VR data yMax=0.7 yCut=0.6 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_yMax_1_yCut_0p85_xCut_0p5_0p95.SetName("VR QCD yMax=1 yCut=0.85 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_yMax_1_yCut_0p7_xCut_0p5_0p95.SetName("VR QCD yMax=1 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.SetName("VR QCD yMax=0.85 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_VR_yMax_0p7_yCut_0p6_xCut_0p5_0p95.SetName("VR QCD yMax=0.7 yCut=0.6 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_data_SR_yMax_0p7_yCut_0p6_xCut_0p5_0p95.SetName("SR data yMax=0.7 yCut=0.6 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             ...
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
gr_M15_ctau1_data_SR_yMax_0p85_yCut_0p7_xCut_0p5_0p95 = ROOT.TGraph()
for i in range(len(cutValue_list)):
    gr_M15_ctau1_data_SR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.SetPoint(i,cutValue_list[i],nonClosure_list[i])
gr_M15_ctau1_data_SR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.SetLineColor(ROOT.kOrange)
gr_M15_ctau1_data_SR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.SetName("SR data yMax=0.85 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             ...
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
gr_M15_ctau1_data_SR_yMax_1_yCut_0p85_xCut_0p5_0p95 = ROOT.TGraph()
for i in range(len(cutValue_list)):
    gr_M15_ctau1_data_SR_yMax_1_yCut_0p85_xCut_0p5_0p95.SetPoint(i,cutValue_list[i],nonClosure_list[i])
gr_M15_ctau1_data_SR_yMax_1_yCut_0p85_xCut_0p5_0p95.SetLineColor(ROOT.kMagenta)
gr_M15_ctau1_data_SR_yMax_1_yCut_0p85_xCut_0p5_0p95.SetName("SR data yMax=1 yCut=0.85 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
cutValue_list, nonClosure_list = scanClosureOneDirection(scanDirection="x",
                             ...
                             histoFile=histoFile, histoString=histoString,
                             dataMode="data", verbosity=0 )
gr_M15_ctau1_data_SR_yMax_1_yCut_0p7_xCut_0p5_0p95 = ROOT.TGraph()
for i in range(len(cutValue_list)):
    gr_M15_ctau1_data_SR_yMax_1_yCut_0p7_xCut_0p5_0p95.SetPoint(i,cutValue_list[i],nonClosure_list[i])
gr_M15_ctau1_data_SR_yMax_1_yCut_0p7_xCut_0p5_0p95.SetLineColor(ROOT.kMagenta+2)
gr_M15_ctau1_data_SR_yMax_1_yCut_0p7_xCut_0p5_0p95.SetName("SR data yMax=1 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_yMax_0p7_yCut_0p6_xCut_0p5_0p95.SetName("SR QCD yMax=0.7 yCut=0.6 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.SetName("SR QCD yMax=0.85 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_yMax_1_yCut_0p85_xCut_0p5_0p95.SetName("SR QCD yMax=1 yCut=0.85 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_QCD_SR_yMax_1_yCut_0p7_xCut_0p5_0p95.SetName("SR QCD yMax=1 yCut=0.7 xCut=[0.5,0.95]")
global_max=max(global_max,max(nonClosure_list))
global_min=min(global_min, min(nonClosure_list))
...
gr_M15_ctau1_data_VR_yMax_1_yCut_0p85_xCut_0p5_0p95.GetXaxis().SetTitle("x-axis cut")
gr_M15_ctau1_data_VR_yMax_1_yCut_0p85_xCut_0p5_0p95.GetYaxis().SetTitle("predicted/observed")
...
gr_M15_ctau1_data_SR_yMax_1_yCut_0p7_xCut_0p5_0p95.Draw("sameL")
gr_M15_ctau1_data_SR_yMax_1_yCut_0p85_xCut_0p5_0p95.Draw("sameL")
gr_M15_ctau1_data_SR_yMax_0p85_yCut_0p7_xCut_0p5_0p95.Draw("sameL")
canvas_M15_ctau1_yWindow.BuildLegend()
canvas_M15_ctau1_yWindow.SetGrid()
canvas_M15_ctau1_yWindow.SaveAs("c_M15_ctau1_yWindow_comparison_invertedChi2.png")
canvas_M15_ctau1_yWindow.SaveAs("c_M15_ctau1_yWindow_comparison_invertedChi2.pdf")
